...
void            display_put_char(
               DisplayContext* ctx, int x, int y, uint16_t ch, uint16_t fg, uint16_t bg);
void display_fill_rect(DisplayContext* ctx,
                       int             x,
                       int             y,
                       int             w,
                       int             h,
...
void display_put_string(DisplayContext* ctx,
                        int             x,
                        int             y,
                        const char*     str,
                        uint16_t        fg,
                        uint16_t        bg);
void display_draw_line_h(DisplayContext* ctx,
                         int             x,
                         int             y,
                         int             len,
                         uint16_t        ch,
                         uint16_t        fg,
                         uint16_t        bg);
void display_draw_line_v(DisplayContext* ctx,
                         int             x,
                         int             y,
                         int             len,
                         uint16_t        ch,
                         uint16_t        fg,
                         uint16_t        bg);
void display_put_hline(DisplayContext* ctx,
                       int             x,
                       int             y,
                       int             len,
                       uint16_t        ch,
                       uint16_t        fg,
                       uint16_t        bg);
void display_put_vline(DisplayContext* ctx,
                       int             x,
                       int             y,
                       int             len,
                       uint16_t        ch,
