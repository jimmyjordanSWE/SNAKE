...
void console_terminal_resized(int w, int h) { console_info("Terminal resized to %dx%d. Resuming game...\n", w, h); }
void console_game_ran(int ticks) { console_info("Game ran for %d ticks\n", ticks); }
