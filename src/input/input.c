    ...
    *out = (InputState){0};
    ...
    for (size_t i = 0; i < n; i++)
    {
        ...
        switch (c)
        {
            ...
            default:
                out->any_key = true;
                if (ascii_tolower((unsigned char)c)
                    == ascii_tolower((unsigned char)s_key_up))
                    out->move_up = true;
                else if (ascii_tolower((unsigned char)c)
                         == ascii_tolower((unsigned char)s_key_down))
                    out->move_down = true;
                else if (ascii_tolower((unsigned char)c)
                         == ascii_tolower((unsigned char)s_key_left))
                    out->turn_left = true;
                else if (ascii_tolower((unsigned char)c)
                         == ascii_tolower((unsigned char)s_key_right))
                    out->turn_right = true;
                else if (ascii_tolower((unsigned char)c)
                         == ascii_tolower((unsigned char)s_key_quit))
                    out->quit = true;
                else if (ascii_tolower((unsigned char)c)
                         == ascii_tolower((unsigned char)s_key_restart))
                    out->restart = true;
                else if (ascii_tolower((unsigned char)c)
                         == ascii_tolower((unsigned char)s_key_pause))
