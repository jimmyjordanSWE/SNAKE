...
snprintf(c->wall_texture, PERSIST_TEXTURE_PATH_MAX, PERSIST_CONFIG_DEFAULT_WALL_TEXTURE);snprintf(c->floor_texture, PERSIST_TEXTURE_PATH_MAX, "%s", PERSIST_CONFIG_DEFAULT_FLOOR_TEXTURE);
...
/* Keep max_players in sync by default to avoid memory waste */
