...
for(int bi= 1; bi < pl->length; bi++) {
float sx= pl->prev_segment_x[bi] + (((float)pl->body[bi].x + 0.5f) - pl->prev_segment_x[bi]) * f_interp;
float sy= pl->prev_segment_y[bi] + (((float)pl->body[bi].y + 0.5f) - pl->prev_segment_y[bi]) * f_interp;
